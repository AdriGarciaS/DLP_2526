// Generated from C:/Users/UO300042/Desktop/DLP_2526/src/parser/Cmm.g4 by ANTLR 4.13.2
package parser;
...
public class CmmParser extends Parser {
	...
	public static class MainFunctionDefinitionContext extends ParserRuleContext {
		...
		public List<Locatable> fullbody = new ArrayList<Locatable>();
	...
	public final MainFunctionDefinitionContext mainFunctionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2061613310072L) != 0)) {
				{
				setState(110);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
				...
				case T__5:
					...
					((MainFunctionDefinitionContext)_localctx).v = varDefinition();
					 _localctx.localVars.addAll(((MainFunctionDefinitionContext)_localctx).v.ast); _localctx.fullbody.addAll(((MainFunctionDefinitionContext)_localctx).v.ast);
					}
					break;
				case T__12:
				case T__14:
				...
				case ID:
					...
					((MainFunctionDefinitionContext)_localctx).s = statement();
					 _localctx.localStmts.addAll(((MainFunctionDefinitionContext)_localctx).s.ast);_localctx.fullbody.addAll(((MainFunctionDefinitionContext)_localctx).s.ast);
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2061613310072L) != 0)) {
				...
				case T__5:
					...
					((FunctionDefinitionContext)_localctx).v = varDefinition();
					 _localctx.localVars.addAll(((FunctionDefinitionContext)_localctx).v.ast); _localctx.fullbody.addAll(((FunctionDefinitionContext)_localctx).v.ast);
					}
					break;
				case T__12:
				case T__14:
				...
				case ID:
					...
					((FunctionDefinitionContext)_localctx).s = statement();
					 _localctx.localStmts.addAll(((FunctionDefinitionContext)_localctx).s.ast);_localctx.fullbody.addAll(((FunctionDefinitionContext)_localctx).s.ast);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			setState(135);
			match(T__7);
			((FunctionDefinitionContext)_localctx).ast =  new FunctionDefinition( ((FunctionDefinitionContext)_localctx).id1.getLine(), ((FunctionDefinitionContext)_localctx).id1.getCharPositionInLine()+1, ((FunctionDefinitionContext)_localctx).returnT.ast, (((FunctionDefinitionContext)_localctx).id1!=null?((FunctionDefinitionContext)_localctx).id1.getText():null), ((FunctionDefinitionContext)_localctx).args.ast, _localctx.localVars, _localctx.localStmts, _localctx.fullbody);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
